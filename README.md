...
- Карточка сотрудника содержит доступные данные из AD: ФИО, должность, подразделение, компанию, внутренний телефон, e-mail, кабинет, офис, руководителя и ссылку на чат в eXpress, если она есть.
